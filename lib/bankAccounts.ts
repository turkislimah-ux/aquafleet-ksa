...
// defends the loosening). Checksum rules DIFFER by ruling: NONE here
// (2026-09-05 — no banking system behind this screen, so mod-97 can only
// reject an operator copying a number off a real bank statement); over there
// shape is HARD and the mod-97 checksum WARNS without ever blocking
// (2026-09-17). Two fields, two rules, deliberately two modules — its header
// says the same about this one. Do not unify.
